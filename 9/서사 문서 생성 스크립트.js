...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            p([body("AI 제안을 따르지 않은 일 — ", { bold: true }), body("없습니다. 이번 초안은 강점을 뽑는 것과 걸러내는 것을 AI가 한 번에 이어서 했기 때문에, “AI가 먼저 내놓고 내가 뒤집은” 순간이 따로 없었습니다. 대신 AI가 아예 대신할 수 없는 두 가지 — 과정 이전의 고난(연도·장소), 동료 두 사람에게 직접 읽혀 받은 답 — 는 자리만 만들어 두고 비워 뒀습니다. 이 문서에서 AI가 못 하는 유일한 부분이 그 둘입니다.")]),

            h2("짧은 확인 방법"),
            p(body("이 문서 안에서:")),
            bullet([body("자기소개서", { bold: true }), body("는 「5. 자기소개서 초안」에 있습니다.")]),
            bullet([body("강점 지도", { bold: true }), body("는 「3. 강점 지도」의 표에 있습니다.")]),
        ],
    }],
});
